...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section */}
      <section className="h-[calc(100vh-4rem)] flex flex-col max-w-[740px]">
        <div className="mt-14 sm:mt-30 mb-7 sm:mb-15 hover:cursor-pointer">
          <Image 
        ...
        <p className="text-2xl sm:text-5xl font-extrabold mb-2 sm:mb-5 hover:cursor-pointer">
